...
filename_original = r"DRS_4.9um_EEDFB_2-23-2024_1.5mm.json"

### I believe this is in degrees?
param_label = 'cleave_phase_shift'
#param_values = [0, 45, 90, 135, 180, 225, 270, 315, 360]
param_values = np.arange(0, 2* np.pi, 2*np.pi * 0.1)
